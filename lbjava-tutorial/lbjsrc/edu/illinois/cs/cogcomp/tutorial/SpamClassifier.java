...
// 
...
public class SpamClassifier extends SparseAveragedPerceptron
{
  ...
  static
  {
    _lcFilePath = SpamClassifier.class.getResource("SpamClassifier.lc");

    if (_lcFilePath == null)
    {
      System.err.println("ERROR: Can't locate SpamClassifier.lc in the class path.");
      System.exit(1);
    }

    _lexFilePath = SpamClassifier.class.getResource("SpamClassifier.lex");

    if (_lexFilePath == null)
    {
      System.err.println("ERROR: Can't locate SpamClassifier.lex in the class path.");
      System.exit(1);
    }
  }
  ...
  private static void loadInstance()
  {
    if (instance == null)
    {
      instance = (SpamClassifier) Learner.readLearner(_lcFilePath);
      instance.readLexiconOnDemand(_lexFilePath);
    }
  }

  public static Parser getParser() { return new edu.illinois.cs.cogcomp.lbjava.parse.ArrayFileParser("/Users/tofuwen/Documents/uiuc_study/Fall_2016/CS_499/examples/lbjava-tutorial/lbjava-tutorial/lbjsrc/edu/illinois/cs/cogcomp/tutorial/SpamClassifier.ex"); }
  public static Parser getTestParser() { return new edu.illinois.cs.cogcomp.lbjava.parse.ArrayFileParser("/Users/tofuwen/Documents/uiuc_study/Fall_2016/CS_499/examples/lbjava-tutorial/lbjava-tutorial/lbjsrc/edu/illinois/cs/cogcomp/tutorial/SpamClassifier.test.ex"); }
  public static boolean isTraining;
  public static SpamClassifier instance;
  ...
  private SpamClassifier(boolean b)
  {
    super(new Parameters());
    containingPackage = "edu.illinois.cs.cogcomp.tutorial";
    name = "SpamClassifier";
    setEncoding(null);
    setLabeler(new SpamLabel());
    setExtractor(new SpamClassifier$$1());
    isClone = false;
  }
  ...
  {
    super("edu.illinois.cs.cogcomp.tutorial.SpamClassifier");
    isClone = true;
  }

	public SpamClassifier(String modelPath, String lexiconPath) { this(new Parameters(), modelPath, lexiconPath); }

	public SpamClassifier(Parameters p, String modelPath, String lexiconPath) {
		super(p);
		try {
		...
		else if (IOUtilities.existsInClasspath(SpamClassifier.class, modelPath)) {
			readModel(IOUtilities.loadFromClasspath(SpamClassifier.class, modelPath));
			readLexiconOnDemand(IOUtilities.loadFromClasspath(SpamClassifier.class, lexiconPath));
		}
		else {
			containingPackage = "edu.illinois.cs.cogcomp.tutorial";
			name = "SpamClassifier";
  ...
  public void learn(Object example)
  {
    if (isClone)
    {
      if (!(example instanceof Document || example instanceof Object[]))
      {
        ...
        System.err.println("Classifier 'SpamClassifier(Document)' defined on line 22 of SpamClassifier.lbj received '" + type + "' as input.");
  ...
  public static void main(String[] args)
  {
    ...
    {
      System.err.println("usage: edu.illinois.cs.cogcomp.tutorial.SpamClassifier \\");
  ...
  public int hashCode() { return "SpamClassifier".hashCode(); }
  public boolean equals(Object o) { return o instanceof SpamClassifier; }
